...
@EnableWs
@Configuration
public class UsuariosConfiguracion extends WsConfigurerAdapter{
    @Bean 
...
@Bean (name = "usuarios")
    public DefaultWsdl11Definition defaultWsdl11Definition (XsdSchema usuariosSchema){
        ...
        wsdl.setLocationUri("/ws/usuarios");
        wsdl.setTargetNamespace("http://tell.me/usuarios");
        wsdl.setSchema(usuariosSchema);
        return wsdl;
    }
